...
class Overload {
	public static void main(String[] args) {
		...
		System.out.println();
		resI = ob.ovlDemo(3,7);
		System.out.println("результат выполнение ob.ovlDemo(3,7): " + resI);
		System.out.println();
		ob.ovlDemo(6);
                System.out.println();
                resD = ob.ovlDemo(3.5, 8.5);
		System.out.println("результат выполнение ob.ovlDemo(3.5,8.5): " + resD);
	

		//Автоматимческое преобразование типов при перегрузке
		System.out.println();
		int i = 10;
		double d = 99.9;
		byte b = 30;
