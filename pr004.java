...
class ErrorMsg {
	String [] msgs = {
		...
		"Ошибка ввода",
		"Переполнение диска",
		"Выход индекса из границы массива",
	};
	//Пример возвврата объекта в виде строки
...
class pr004 {
	public static void main(String [] args) {
		...
		System.out.println("объём ob1 эквивалентен объёму  ob2" + ob1.sameV(ob3));

		System.out.println();
		//Пример передачи параметров по значению
		ByValue ob4 = new ByValue();
		int a = 15, b = 20;
		System.out.println("a и b перед вызовом метода no change():" + a + " " + b);
		ob4.noChange(a, b);
		System.out.println("a и b перед вызовом метода no change():" + a + " " + b);
		//Значения после a b  вызова метода no change()  не изменяются
		System.out.println();
		
		//пример передачи параметров по ссылке
		ByRef ob5 = new ByRef(15,20);
		System.out.println("ob5.a ob5.b перед вызовом метода change(): " + ob5.a + " " + ob5.b);
		ob5.change(ob5);
		System.out.println("ob5.a ob5.b перед вызовом метода change(): " + ob5.a + " " + ob5.b);
		...
		//Демонстрация вовзрата строки методом
